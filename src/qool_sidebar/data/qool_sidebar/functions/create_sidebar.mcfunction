...
function qool_sidebar_internal:create_sidebar with storage qool_sidebar:storage

execute if entity @s[tag=map_maker] run function qool_sidebar_internal:display_info_to_player with storage qool_sidebar:storage
